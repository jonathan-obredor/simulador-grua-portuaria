function [alturaInicioDesplazamientoCarro, PosicionCarroInicioDescensoIzaje,ySeguridadCarro, x_origen, x_destino,y_destino]= trayectoriaSegunBotonBarco(nroBoton,~) %geometria)
...
x_destino=geometria.divHoriz*nroBoton;%xt_min+divHoriz*nroBoton;
